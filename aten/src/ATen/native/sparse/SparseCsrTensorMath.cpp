...
Tensor _csr_to_block_csr_cuda(const Tensor& self, IntArrayRef blocksize) {
  ...
  Tensor cpu_result = _csr_to_block_csr_cpu(_sparse_csr_tensor_unsafe(
      input_crow_indices,
      input_col_indices,
      input_values,
      self.sizes(),
